...
public class Utility_commonFunction {
	...
	{
		File newfile=new File("C:\\Users\\sai\\Desktop\\ECLIPSE\\" +filename+".txt");
     ...
     public static ArrayList<String>readdataexcel(String sheetname,String testcasename) throws IOException
     {
    	...
    	FileInputStream fis= new FileInputStream("C:\\Users\\sai\\Desktop\\ECLIPSE\\API_Filedata_text.xlsx");
